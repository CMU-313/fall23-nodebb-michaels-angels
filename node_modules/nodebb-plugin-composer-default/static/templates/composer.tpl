	...
	<div class="composer-container">
		...
		<div class="row title-container">
			...
			<div class="btn-group pull-right action-bar hidden-sm hidden-xs">
				...
				<button class="btn btn-primary composer-submit" data-action="post" tabindex="6" data-text-variant=" [[topic:composer.schedule]]"><i class="fa fa-question"></i> Submit Anonymously</button>
